...
module RubyOutlook
  ...
  class Client
    ...
    attr_writer :enable_fiddler, :version
    ...
    def make_api_call(method, url, token, params = nil, payload = {}, custom_headers = nil)
      conn_params = {
        url: format(@api_host, version: @version)
      }
      ...
      conn.headers = conn.headers.merge(custom_headers) if custom_headers && custom_headers.instance_of?(Hash)
    ...
    def create_contact(token, payload, folder_id = nil, user = nil)
      ...
      request_url << '/ContactFolders/' << folder_id unless folder_id.nil?
    ...
    def create_message(token, payload, folder_id = nil, user = nil)
      ...
      request_url << '/MailFolders/' << folder_id unless folder_id.nil?
    ...
    def create_calendar(token, payload, calendar_group_id = nil, user = nil)
      ...
      request_url << '/CalendarGroups/' << calendar_group_id unless calendar_group_id.nil?
    ...
    def get_calendar_view(token, window_start, window_end, id = nil, fields = nil, user = nil, limit = 10)
      ...
      request_url << '/Calendars/' << id unless id.nil?
    ...
    def create_event(token, payload, folder_id = nil, user = nil)
      ...
      request_url << '/Calendars/' << folder_id unless folder_id.nil?
